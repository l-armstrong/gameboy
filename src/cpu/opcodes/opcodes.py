...
class Opcodes(object):
    ...
    def init_opcodes(self):
        return {
	        ...
	        0xA0: Opcode(0xA0, "AND A B", 1, 4),
	        0xA1: Opcode(0xA1, "AND A C", 1, 4),
	        0xA2: Opcode(0xA2, "AND A D", 1, 4),
	        0xA3: Opcode(0xA3, "AND A E", 1, 4),
	        0xA4: Opcode(0xA4, "AND A H", 1, 4),
	        0xA5: Opcode(0xA5, "AND A L", 1, 4),
	        0xA6: Opcode(0xA6, "AND A HL", 1, 8),
	        0xA7: Opcode(0xA7, "AND A A", 1, 4),
