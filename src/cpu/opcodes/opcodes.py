...
class Opcodes(object):
    ...
    def init_opcodes(self):
        ...
        return {
            ...
            0x86: Opcode(0x86, "ADD A HL", 1, 8, lambda: self._add(self.mmu.read_byte(self.regs.read_hl()))),
            ...
            0x8E: Opcode(0x8E, "ADC A HL", 1, 8, lambda: self._adc(self.mmu.read_byte(self.regs.read_hl()))),
            ...
            0x96: Opcode(0x96, "SUB A HL", 1, 8, lambda: self._sub(self.mmu.read_byte(self.regs.read_hl()))),
            ...
            0x9E: Opcode(0x9E, "SBC A HL", 1, 8, lambda: self._subc(self.mmu.read_byte(self.regs.read_hl()))),
            ...
            0xA6: Opcode(0xA6, "AND A HL", 1, 8, lambda: self._and(self.mmu.read_byte(self.regs.read_hl()))),
            ...
            0xAE: Opcode(0xAE, "XOR A HL", 1, 8, lambda: self._xor(self.mmu.read_byte(self.regs.read_hl()))),
            ...
            0xB6: Opcode(0xB6, "OR A HL", 1, 8, lambda: self._or(self.mmu.read_byte(self.regs.read_hl()))),
            ...
            0xBE: Opcode(0xBE, "CP A HL", 1, 8, lambda: self._cp(self.mmu.read_byte(self.regs.read_hl()))),
