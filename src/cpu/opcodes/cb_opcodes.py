...
class CB_Opcodes(object):
    ...
    def init_cb_opcodes(self):
        ...
        return {
            ...
            0x06: Opcode(0x06, "RLC HL", 2, 16, lambda: self._rlc_hl()),
            ...
            0x0E: Opcode(0x0E, "RRC HL", 2, 16, lambda: self._rrc_hl()),
            ...
            0x16: Opcode(0x16, "RL HL", 2, 16, lambda: self._rl_hl()),
            ...
            0x1E: Opcode(0x1E, "RR HL", 2, 16, lambda: self._rr_hl()),
            ...
            0x26: Opcode(0x26, "SLA HL", 2, 16, lambda: self._sla_hl()),
            ...
            0x2E: Opcode(0x2E, "SRA HL", 2, 16, lambda: self._sra_hl()),
            ...
            0x36: Opcode(0x36, "SWAP HL", 2, 16, lambda: self._swap_hl()),
            ...
            0x3E: Opcode(0x3E, "SRL HL", 2, 16, lambda: self._srl_hl()),
            ...
            0x46: Opcode(0x46, "BIT 0 HL", 2, 12, lambda: self._bit_hl(0)),
            ...
            0x4E: Opcode(0x4E, "BIT 1 HL", 2, 12, lambda: self._bit_hl(1)),
            ...
            0x56: Opcode(0x56, "BIT 2 HL", 2, 12, lambda: self._bit_hl(2)),
            ...
            0x5E: Opcode(0x5E, "BIT 3 HL", 2, 12, lambda: self._bit_hl(3)),
            ...
            0x66: Opcode(0x66, "BIT 4 HL", 2, 12, lambda: self._bit_hl(4)),
            ...
            0x6E: Opcode(0x6E, "BIT 5 HL", 2, 12, lambda: self._bit_hl(5)),
            ...
            0x76: Opcode(0x76, "BIT 6 HL", 2, 12, lambda: self._bit_hl(6)),
            ...
            0x7E: Opcode(0x7E, "BIT 7 HL", 2, 12, lambda: self._bit_hl(7)),
            ...
            0x86: Opcode(0x86, "RES 0 HL", 2, 16, lambda: self._res_hl(0)),
            ...
            0x8E: Opcode(0x8E, "RES 1 HL", 2, 16, lambda: self._res_hl(1)),
            ...
            0x96: Opcode(0x96, "RES 2 HL", 2, 16, lambda: self._res_hl(2)),
            ...
            0x9E: Opcode(0x9E, "RES 3 HL", 2, 16, lambda: self._res_hl(3)),
            ...
            0xA6: Opcode(0xA6, "RES 4 HL", 2, 16, lambda: self._res_hl(4)),
            ...
            0xAE: Opcode(0xAE, "RES 5 HL", 2, 16, lambda: self._res_hl(5)),
            ...
            0xB6: Opcode(0xB6, "RES 6 HL", 2, 16, lambda: self._res_hl(6)),
            ...
            0xBE: Opcode(0xBE, "RES 7 HL", 2, 16, lambda: self._res_hl(7)),
            0xBF: Opcode(0xBF, "RES 7 A", 2, 8, lambda: self._res(REG_A, 7)),
            0xC0: Opcode(0xC0, "SET 0 B", 2, 8, lambda: self._set(REG_B, 0)),
            0xC1: Opcode(0xC1, "SET 0 C", 2, 8, lambda: self._set(REG_C, 0)),
            0xC2: Opcode(0xC2, "SET 0 D", 2, 8, lambda: self._set(REG_D, 0)),
            0xC3: Opcode(0xC3, "SET 0 E", 2, 8, lambda: self._set(REG_E, 0)),
            0xC4: Opcode(0xC4, "SET 0 H", 2, 8, lambda: self._set(REG_H, 0)),
            0xC5: Opcode(0xC5, "SET 0 L", 2, 8, lambda: self._set(REG_L, 0)),
            0xC6: Opcode(0xC6, "SET 0 HL", 2, 16, lambda: self._set_hl(0)),
            0xC7: Opcode(0xC7, "SET 0 A", 2, 8, lambda: self._set(REG_A, 0)),
            0xC8: Opcode(0xC8, "SET 1 B", 2, 8, lambda: self._set(REG_B, 1)),
            0xC9: Opcode(0xC9, "SET 1 C", 2, 8, lambda: self._set(REG_C, 1)),
            0xCA: Opcode(0xCA, "SET 1 D", 2, 8, lambda: self._set(REG_D, 1)),
            0xCB: Opcode(0xCB, "SET 1 E", 2, 8, lambda: self._set(REG_E, 1)),
            0xCC: Opcode(0xCC, "SET 1 H", 2, 8, lambda: self._set(REG_H, 1)),
            0xCD: Opcode(0xCD, "SET 1 L", 2, 8, lambda: self._set(REG_L, 1)),
            0xCE: Opcode(0xCE, "SET 1 HL", 2, 16, lambda: self._set_hl(1)),
            0xCF: Opcode(0xCF, "SET 1 A", 2, 8, lambda: self._set(REG_A, 1)),
            0xD0: Opcode(0xD0, "SET 2 B", 2, 8, lambda: self._set(REG_B, 2)),
            0xD1: Opcode(0xD1, "SET 2 C", 2, 8, lambda: self._set(REG_C, 2)),
            0xD2: Opcode(0xD2, "SET 2 D", 2, 8, lambda: self._set(REG_D, 2)),
            0xD3: Opcode(0xD3, "SET 2 E", 2, 8, lambda: self._set(REG_E, 2)),
            0xD4: Opcode(0xD4, "SET 2 H", 2, 8, lambda: self._set(REG_H, 2)),
            0xD5: Opcode(0xD5, "SET 2 L", 2, 8, lambda: self._set(REG_L, 2)),
            0xD6: Opcode(0xD6, "SET 2 HL", 2, 16, lambda: self._set_hl(2)),
            0xD7: Opcode(0xD7, "SET 2 A", 2, 8, lambda: self._set(REG_A, 2)),
            0xD8: Opcode(0xD8, "SET 3 B", 2, 8, lambda: self._set(REG_B, 3)),
            0xD9: Opcode(0xD9, "SET 3 C", 2, 8, lambda: self._set(REG_C, 3)),
            0xDA: Opcode(0xDA, "SET 3 D", 2, 8, lambda: self._set(REG_D, 3)),
            0xDB: Opcode(0xDB, "SET 3 E", 2, 8, lambda: self._set(REG_E, 3)),
            0xDC: Opcode(0xDC, "SET 3 H", 2, 8, lambda: self._set(REG_H, 3)),
            0xDD: Opcode(0xDD, "SET 3 L", 2, 8, lambda: self._set(REG_L, 3)),
            0xDE: Opcode(0xDE, "SET 3 HL", 2, 16, lambda: self._set_hl(3)),
            0xDF: Opcode(0xDF, "SET 3 A", 2, 8, lambda: self._set(REG_A, 3)),
            0xE0: Opcode(0xE0, "SET 4 B", 2, 8, lambda: self._set(REG_B, 4)),
            0xE1: Opcode(0xE1, "SET 4 C", 2, 8, lambda: self._set(REG_C, 4)),
            0xE2: Opcode(0xE2, "SET 4 D", 2, 8, lambda: self._set(REG_D, 4)),
            0xE3: Opcode(0xE3, "SET 4 E", 2, 8, lambda: self._set(REG_E, 4)),
            0xE4: Opcode(0xE4, "SET 4 H", 2, 8, lambda: self._set(REG_H, 4)),
            0xE5: Opcode(0xE5, "SET 4 L", 2, 8, lambda: self._set(REG_L, 4)),
            0xE6: Opcode(0xE6, "SET 4 HL", 2, 16, lambda: self._set_hl(4)),
            0xE7: Opcode(0xE7, "SET 4 A", 2, 8, lambda: self._set(REG_A, 4)),
            0xE8: Opcode(0xE8, "SET 5 B", 2, 8, lambda: self._set(REG_B, 5)),
            0xE9: Opcode(0xE9, "SET 5 C", 2, 8, lambda: self._set(REG_C, 5)),
            0xEA: Opcode(0xEA, "SET 5 D", 2, 8, lambda: self._set(REG_D, 5)),
            0xEB: Opcode(0xEB, "SET 5 E", 2, 8, lambda: self._set(REG_E, 5)),
            0xEC: Opcode(0xEC, "SET 5 H", 2, 8, lambda: self._set(REG_H, 5)),
            0xED: Opcode(0xED, "SET 5 L", 2, 8, lambda: self._set(REG_L, 5)),
            0xEE: Opcode(0xEE, "SET 5 HL", 2, 16, lambda: self._set_hl(5)),
            0xEF: Opcode(0xEF, "SET 5 A", 2, 8, lambda: self._set(REG_A, 5)),
            0xF0: Opcode(0xF0, "SET 6 B", 2, 8, lambda: self._set(REG_B, 6)),
            0xF1: Opcode(0xF1, "SET 6 C", 2, 8, lambda: self._set(REG_C, 6)),
            0xF2: Opcode(0xF2, "SET 6 D", 2, 8, lambda: self._set(REG_D, 6)),
            0xF3: Opcode(0xF3, "SET 6 E", 2, 8, lambda: self._set(REG_E, 6)),
            0xF4: Opcode(0xF4, "SET 6 H", 2, 8, lambda: self._set(REG_H, 6)),
            0xF5: Opcode(0xF5, "SET 6 L", 2, 8, lambda: self._set(REG_L, 6)),
            0xF6: Opcode(0xF6, "SET 6 HL", 2, 16, lambda: self._set_hl(6)),
            0xF7: Opcode(0xF7, "SET 6 A", 2, 8, lambda: self._set(REG_A, 6)),
            0xF8: Opcode(0xF8, "SET 7 B", 2, 8, lambda: self._set(REG_B, 7)),
            0xF9: Opcode(0xF9, "SET 7 C", 2, 8, lambda: self._set(REG_C, 7)),
            0xFA: Opcode(0xFA, "SET 7 D", 2, 8, lambda: self._set(REG_D, 7)),
            0xFB: Opcode(0xFB, "SET 7 E", 2, 8, lambda: self._set(REG_E, 7)),
            0xFC: Opcode(0xFC, "SET 7 H", 2, 8, lambda: self._set(REG_H, 7)),
            0xFD: Opcode(0xFD, "SET 7 L", 2, 8, lambda: self._set(REG_L, 7)),
            0xFE: Opcode(0xFE, "SET 7 HL", 2, 16, lambda: self._set_hl(7)),
            0xFF: Opcode(0xFF, "SET 7 A", 2, 8, lambda: self._set(REG_A, 7)),
        }        
    
    def _rlc(self, reg):
        # rotate reg val to left (circular)
        #val = getattr(self, reg)
        val, hl_reg = self._get_val(reg)
        # rotate bits
        ...
        self.mmu.write_byte(self.regs.hl(), val) if hl_reg else setattr(self, reg, res)

    def _rlc_hl(self):
        # rotate reg hl val to left (circular) 
    ...
    def _rrc_hl(self):
        # rotate reg hl val to right (circular)
        val = self.mmu.read_byte(self.regs.hl())
        self._rrc(val)
    ...
    def _set_hl(self, pos):
        # set bit pos in reg hl val 
        val = self.mmu.read_byte(self.regs.hl())
        self._set(val, pos)
    ...
    def _res_hl(self, pos):
        # reset bit pos in reg hl val
        val = self.mmu.read_byte(self.regs.hl())
        self._res(val, pos)
    ...
    def _bit(self, reg, pos):
        # test bit
        #val = getattr(self, reg)
        val, _ = self._get_val(reg)
        self.regs.f |= self.regs.HALF_CARRY_FLAG
        if ((val >> pos) & 0x1) == 0: self.regs.f |= self.regs.ZERO_FLAG
        # turn off N
        self.regs.f &= ~(1 << 6)

    def _bit_hl(self, pos):
        # test bit hl
        val = self.mmu.read_byte(self.regs.hl())
        self._bit(val, pos)

    def _get_val(self, val): 
        return getattr(self, val), False if val in self.regs.__dict__.keys() else val, True