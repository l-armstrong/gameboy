...
class Z80(object):
    ...
    def ldrr_bb(self): self.ldrr_nn("_r_b", "_r_c")

    # load byte from reg b to reg d
    def ldrr_bb(self): self.ldrr_nn("_r_b", "_r_d")

    # load byte from reg b to reg e
    def ldrr_bb(self): self.ldrr_nn("_r_b", "_r_e")

    # load byte from reg b to reg h
    def ldrr_bb(self): self.ldrr_nn("_r_b", "_r_h")

    # load byte from reg b to reg l
    def ldrr_bb(self): self.ldrr_nn("_r_b", "_r_l")
    # load byte from reg b to reg a
    def ldrr_bb(self): self.ldrr_nn("_r_b", "_r_a")
